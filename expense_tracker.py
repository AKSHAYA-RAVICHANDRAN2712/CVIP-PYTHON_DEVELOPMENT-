...
def appwindow():
    ...
    def endpage():
        ...
        Label(gui,font=("lucida fax",40),bg="#bfbfbf",text="EXPENSE Sharing App").place(x=190,y=10)
        ...
        Label(gui,font=("ink free",35),bg="#bfbfbf",text="AKSHAYA.R").place(x=500,y=450)
    ...
    l6=Label(gui,width=60,font=("century",35),bg="#ff9999",fg="#b32d00",text="EXPENSE SHARING APP").place(x=-450,y=0)
...
Label(root,width=60,font=("jokerman",35),bg="#ff9999",fg="#cc2900",text="EXPENSE SHARING APP").place(x=-400,y=0)
Label(root,font=("Ink Free",27),bg="#33cccc",fg="#0000ff",text="AKSHAYA.R").place(x=750,y=590)
